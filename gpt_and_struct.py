...
CT2B = "\nThis is the end of the dispatch communication, return a simple incident summary in this format: TYPE: category(str) | LOCATION: place(str, be very specific) | LEVEL: level_of_threat(int). If a variable can not be determined, simply fill it with NA."
